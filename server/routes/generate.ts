...
const getInvestorResponse = (message: string, category: string = "general") => {
  const responses: Partial<Record<string, CategoryResponse>> & {
    restaurants: CategoryResponse;
  } = {
    restaurants: {
      businessSetup: {
        response:
          "For restaurant investment in Abu Dhabi, you'll need a Commercial License for F&B. The process involves obtaining health permits, liquor license (if applicable), municipality approvals, and fire safety clearance. Initial investment typically ranges from AED 500,000 to AED 2M depending on size and location.",
        investorData: {
      ...
      marketAnalysis: {
        response:
          "Abu Dhabi's F&B market is valued at AED 12.8B with 15% annual growth. High-demand areas include Al Reem Island, Corniche, and Marina Mall vicinity. Average restaurant ROI is 18-25% within 2-3 years for well-positioned establishments.",
        actions: [
          {
    ...
    "fast-food": {
      businessSetup: {
        response:
          "Fast food franchises in Abu Dhabi require a Commercial License and franchise agreements. Initial investment ranges from AED 200,000 to AED 800,000. Popular locations include malls, business districts, and residential areas. Approval process takes 4-6 weeks.",
        actions: [
          {
    ...
    "retail-store": {
      businessSetup: {
        response:
          "Retail business in Abu Dhabi requires a Commercial License for Trading. Consider e-commerce integration for broader reach. Prime retail locations include Yas Mall, Marina Mall, and Al Wahda Mall. Initial investment varies from AED 150,000 to AED 1.5M.",
        actions: [
          { label: "E-commerce setup", type: "primary", action: "ecommerce" },
          {
            label: "Mall partnerships",
            type: "secondary",
            action: "partnerships",
          },
        ],
