...
const JourneyCard: React.FC<JourneyCardProps> = ({
  ...
  const progressBasis = progress > 0 ? progress : progressPercentage;
  const clampedProgress = Math.min(100, Math.max(0, progressBasis));
  const progressValue = Math.round(clampedProgress);
