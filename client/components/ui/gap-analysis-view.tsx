      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-6 lg:px-12">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-col text-right">
            <span className="text-xs font-semibold uppercase tracking-[0.24em] text-[#0F766E]">Gap analysis report</span>
            <span className="text-sm text-slate-500">Abu Dhabi Corniche focus</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col gap-6 px-6 pb-10 lg:px-12">
              ...
              <div className="rounded-2xl border border-[#d8e4df] bg-white/90 p-6 shadow-[0_12px_32px_-26px_rgba(11,64,55,0.3)]">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs uppercase tracking-[0.2em] text-[#0E766E]">Gap analysis</div>
                  </div>
                </div>

                <div className="mt-6 space-y-4 text-sm leading-relaxed text-slate-600">
                  <div>
                    <h3 className="font-semibold text-slate-900">Insights for this area</h3>
                    <p className="mt-1">Emirati Fusion Cuisine with Japanese influence is shaping new dining trends.</p>
                  </div>
                  <p>Strong demand exists for formal evening dining experiences with premium ambience.</p>
                  <div>
                    <p>Waterfront locations are most desirable.</p>
                    <p>High-rise luxury experiences remain popular with affluent segments.</p>
                  </div>
                </div>
              </div>

              <div className="rounded-2xl border border-[#d8e4df] bg-white/90 p-6 shadow-[0_12px_32px_-26px_rgba(11,64,55,0.3)]">
                <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-[#0E766E]">Strategic guidance</h3>
                <ul className="mt-4 space-y-3 text-sm text-slate-600">
                  <li className="flex items-start gap-2">
                    <span className="mt-2 inline-flex h-1.5 w-1.5 rounded-full bg-[#0E766E]" />
                    Curate premium fusion tasting menus aligned with Japanese influence trends.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-2 inline-flex h-1.5 w-1.5 rounded-full bg-[#0E766E]" />
                    Prioritize venues offering skyline or waterfront views for evening service.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-2 inline-flex h-1.5 w-1.5 rounded-full bg-[#0E766E]" />
        ...
        >
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <span className="text-xs font-semibold uppercase tracking-[0.24em] text-[#0E766E]">Insights</span>
              <h3 className="mt-1 text-xl font-semibold text-slate-900">Abu Dhabi Corniche metrics</h3>
              <p className="mt-3 max-w-xl text-sm leading-relaxed text-slate-600">
                Corniche audiences blend affluent residents, luxury hotel guests, and experience-driven tourists, supporting elevated price points with high revisit frequency.
              </p>
            </div>

            <div className="grid gap-6 sm:grid-cols-3">
              <div className="rounded-2xl border border-[#d8e4df] bg-slate-50/80 p-4 text-center sm:text-left">
                <div className="text-xs uppercase tracking-[0.18em] text-slate-500">Expats in area</div>
                <div className="mt-2 text-3xl font-bold text-[#0E766E]">85-90%</div>
              </div>
              <div className="rounded-2xl border border-[#d8e4df] bg-slate-50/80 p-4 text-center sm:text-left">
                <div className="text-xs uppercase tracking-[0.18em] text-slate-500">Eat out weekly</div>
                <div className="mt-2 text-3xl font-bold text-[#0E766E]">2.5x</div>
              </div>
              <div className="rounded-2xl border border-[#d8e4df] bg-slate-50/80 p-4 text-center sm:text-left">
                <div className="text-xs uppercase tracking-[0.18em] text-slate-500">% who dine out</div>
                <div className="mt-2 text-3xl font-bold text-[#0E766E]">78%</div>
              </div>
            </div>
          </div>
        </motion.div>
