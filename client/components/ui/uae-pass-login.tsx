        ...
        return (
          ...
          >
            <div className="flex items-start gap-4">
              <div
                className={cn(
                  "flex h-16 w-[120px] items-center justify-center rounded-xl text-lg font-semibold",
    ...
    >
      ...
      <div className="rounded-3xl border border-slate-200 bg-white/90 shadow-[0_18px_48px_-28px_rgba(15,23,42,0.45)]">
        <div className="flex items-start gap-4 px-6 pt-6">
          <div
            className={cn(
              "flex w-16 h-[120px] items-center justify-center rounded-xl text-lg font-semibold transition-shadow duration-200",
              isReviewer
