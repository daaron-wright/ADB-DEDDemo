...
const INITIAL_MESSAGES: SimpleChatMessage[] = [
  ...
  },
  {
    id: "ai-1",
    content:
      "Opening a restaurant in Abu Dhabi involves several steps: planning, licensing, approvals, staffing, fit-out, and operations.",
    isAI: true,
    timestamp: new Date(),
    type: "text",
  },
  ...
  },
  {
    id: "ai-4",
    content:
      "Estimated setup costs for the trade license typically fall between AED 3,000 and AED 8,000. Costs below this band usually reflect limited permits, while a full Commercial License that enables restaurant operations generally sits within the AED 3,000 to AED 8,000 range. Cost shown is indicative and subject to change based on the business activity and other regulatory requirements.",
    isAI: true,
    timestamp: new Date(),
    type: "text",
  },
  ...
  const handleSendMessage = useCallback((content: string) => {
    ...
    setTimeout(() => {
      const aiResponse: SimpleChatMessage = {
        id: `ai-${Date.now()}`,
        content:
          "I can help you with that. Let me provide you with more detailed information about restaurant setup in Abu Dhabi.",
        isAI: true,
        timestamp: new Date(),
        type: "text",
      };
