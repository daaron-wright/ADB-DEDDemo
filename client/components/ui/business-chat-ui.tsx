  ...
  return (
    <form onSubmit={handleSubmit} className={cn("w-full max-w-[691px]", className)}>
      <div className="flex h-[39px] w-full items-center justify-center gap-4 rounded-full bg-white/20 px-[13px] py-[16px] backdrop-blur-sm">
        ...
        <button
          type="button"
          className="flex h-4 w-4 flex-shrink-0 items-center justify-center text-white transition-colors hover:text-white/80"
...
export function BusinessChatUI({
  ...
  const [view, setView] = useState<ChatView>("basic\");\n  const [currentView, setCurrentView] = useState<ChatView>(\"basic");
