...
type ChatView = "journey" | "discover-experience" | "corniche-detail" | "compilation" | "dashboard" | "competitors" | "final-compilation";
...
const CompetitorAnalysisView = ({ onBack, onGapAnalysis, onSendMessage }: { onBack: () => void; onGapAnalysis: () => void; onSendMessage?: (message: string) => void }) => (
  <div className="relative w-full min-h-screen bg-[#0B0C28] overflow-hidden">
    ...
    {/* Main Content */}
    <div className="relative z-10 p-4 lg:p-8 min-h-[calc(100vh-87px)]">
      {/* Notification Banner */}
      <motion.div
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <div className="w-72 sm:w-80 lg:w-[340px]">
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/3e6d5f6b9acc69a87e4bcc76536ec7140340c252?width=680"
              alt="Shurfa Bay Restaurant"
              className="w-full h-[280px] sm:h-[320px] lg:h-[342px] object-cover rounded-3xl"
            />
            <div className="relative -mt-24 mx-4 p-6 rounded-b-3xl bg-white/10 backdrop-blur-[40px] border-t border-white/20">
              <h3 className="text-white text-xl sm:text-2xl font-normal leading-tight">
                Shurfa Bay
              </h3>
              <p className="text-white/90 text-lg mt-1">Al Bateen, Abu Dhabi</p>
            </div>
          </div>
        </motion.div>

        {/* Villa Toscana - Top Right */}
        <motion.div
          initial={{ x: 100, y: -50, opacity: 0 }}
          animate={{ x: 0, y: 0, opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.4 }}
          className="absolute top-60 right-0 lg:right-8"
        >
          <div className="w-60 sm:w-64 lg:w-[248px]">
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/df1e40725eb1f230e3df15cd8d949ee274a1c9dd?width=496"
              alt="Villa Toscana Restaurant"
              className="w-full h-[200px] sm:h-[220px] lg:h-[248px] object-cover rounded-3xl"
            />
            <div className="relative -mt-20 mx-3 p-4 rounded-b-3xl bg-white/10 backdrop-blur-[40px] border-t border-white/20">
              <h3 className="text-white text-lg font-normal">Villa Toscana</h3>
              <p className="text-white/90 text-sm">The St Regis Abu Dhabi</p>
            </div>
          </div>
        </motion.div>

        {/* Palms & Pearls - Bottom Left */}
        <motion.div
          initial={{ x: -100, y: 100, opacity: 0 }}
          animate={{ x: 0, y: 0, opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.6 }}
          className="absolute bottom-32 left-8 lg:left-16"
        >
          <div className="w-56 sm:w-60 lg:w-[236px]">
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/9c0a40e0fbebae5a6bba8355f1193760feb2d391?width=472"
              alt="Palms & Pearls Restaurant"
              className="w-full h-[180px] sm:h-[200px] lg:h-[236px] object-cover rounded-3xl"
            />
            <div className="relative -mt-20 mx-3 p-4 rounded-b-3xl bg-white/10 backdrop-blur-[40px] border-t border-white/20">
              <h3 className="text-white text-lg font-normal">Palms & Pearls</h3>
              <p className="text-white/90 text-sm">Corniche, Abu Dhabi</p>
            </div>
          </div>
        </motion.div>

        {/* Gathering Progress - Bottom Right */}
        <motion.div
          initial={{ x: 100, y: 100, opacity: 0 }}
          animate={{ x: 0, y: 0, opacity: 1 }}
        ...
        >
          <div className="w-64 sm:w-72 lg:w-[268px] h-64 sm:h-72 lg:h-[268px] rounded-3xl bg-gradient-to-br from-cyan-400/20 to-teal-600/20 backdrop-blur-xl border border-white/20 shadow-[8px_8px_32px_0_#33A7AD] flex flex-col items-center justify-center p-6 text-center">
            <h3 className="text-white text-lg font-medium mb-4">Gathering Competitor Data</h3>
            <div className="w-32 h-4 bg-white/20 rounded-full overflow-hidden mb-2">
              <motion.div
            ...
            <span className="text-white text-sm opacity-80">76%</span>
          </div>
        </motion.div>
        ...
        >
          <div className="w-[350px] sm:w-[400px] lg:w-[450px] bg-white/14 backdrop-blur-md rounded-3xl border border-white/20 p-4 lg:p-6">
            {/* AI Business Header */}
                ...
                >
                  {[5.77, 11.95, 19.78, 13.19, 8.66, 23.08, 30.5, 16.9, 4.53].map((height, index) => (
                    <motion.div
                      ...
                      animate={{
                        height: [`${height * 0.4}px`, `${height * 0.8}px`, `${height * 0.6}px`],
                      }}
                      transition={{
                        duration: 1.5,
                        repeat: Infinity,
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end">
                <div className="max-w-[240px] bg-black/30 rounded-xl px-4 py-3">
                  <p className="text-white text-sm">Who are the top competitors in the area?</p>
                </div>
              </div>
              ...
              <div className="flex justify-end">
                <div className="max-w-[240px] bg-black/50 rounded-xl px-4 py-3">
                  <p className="text-white text-sm">Can you provide a gap analysis on these?</p>
                </div>
              </div>
                            ...
                            <UAEPassLogin
                              ...
                              trigger={
                                <div
                                  ...
                                  className="w-full flex cursor-pointer items-center justify-between p-4 rounded-2xl bg-white/20 backdrop-blur-sm border border-white/10 hover:bg-white/25 transition-all duration-200 group outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#54ffd4]"
                                >
