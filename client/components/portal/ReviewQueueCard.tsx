    ...
    >
      ...
      <div className="mt-6 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        <div className="flex w-full flex-1 items-center gap-4 text-slate-900">
          <Progress value={item.completion} className="h-2 flex-1 overflow-hidden rounded-full bg-[#e3efea]" />
          <span className="text-sm font-medium text-[#0f766e]">{item.completion}% checklist complete</span>
        </div>
