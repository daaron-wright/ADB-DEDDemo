...
const TRADE_NAME_CHECKS: ReadonlyArray<TradeNameVerificationStep> = [
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "5. وكيل توافق النشاط → إرشاد. ننتظر ��سمً�� تجاريًا فريدًا لموازنته مع النشاط المرخ��ص.",
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        '1. مدقق النص / التدقيق الإملائي / الفحص الثقافي → ناجح. تم توحيد "بيت الختيار" دون ��عارضات ثقافية.',
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "2. وكيل الكلمات المحظورة → ناجح. لم يتم رصد مفردات محظورة في النسختين العربية أو الإنجليز��ة.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "4. وكيل التحويل الصوتي → ن��جح. النسخة العربية متوافقة مع القواعد الصوتية.",
