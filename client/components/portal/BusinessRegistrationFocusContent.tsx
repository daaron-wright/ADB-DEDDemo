  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "5. وكيل توافق النشاط → إرشاد. ننتظر اسمًا تجاريًا فريدًا ��موازنته مع النشاط المرخ��ص.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "��� وكيل اقتراح ال��سم (الاسم المرفوض) → ل�� حاجة لبدائل�� الاسم الحالي معتمد.",
      ].join("\n"),
    },
  },
  {
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "4. وكيل التحويل الصوتي → متوقف مؤقتًا. يجب حل التعارض قبل تأكيد ��لنسخة العربية.",
