  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "2. وكيل الكلمات المحظورة → ناجح. لا توجد مفردات محظورة في النسخت��ن الإنجليزية أو العربية.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل ��وافق ا��نشاط → ناجح. الاسم يتوافق مع نشاط ال��طعم المر���ّص.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "6. محرك القرار النهائي → تم التصعيد للمراجعة. لسنا واثقين من الر��ض الآلي، لذلك تم رفعه لمراجع دائرة التنمية الاق��صادية لتحديد الإجراء.",
