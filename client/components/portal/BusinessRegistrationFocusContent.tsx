...
const TRADE_NAME_CHECKS: ReadonlyArray<TradeNameVerificationStep> = [
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "4. وكيل التحويل الصوتي → متوقف مؤقتًا. يجب حل ا��تعارض قبل تأكيد النسخ�� العربية.",
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        '1. مدقق النص / التدقيق الإملا��ي / الفحص الثقافي → ناجح. تم توحيد "بيت الختيار" دون تعارضات ثقافية.',
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "2. وكيل الكلمات المحظورة → ناجح. لم ي��م رصد مفردات محظورة في النسختين العربية أو الإنجليزية.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "3. وكيل التشابه → ناجح. تم تأكي�� تميز الاسم في السجل.",
