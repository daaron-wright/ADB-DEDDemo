  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "• وكيل الكلمات المحظورة → ناجح. لم يتم العثور على أي مفردات محظورة في النسختين ال��ربية والإنجليزية.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل الكلمات المحظورة → ناجح. لم يتم العثور على مصطلح��ت محظورة في النسختين العربية والإنجليزية.",
        "• ��كيل التشابه → ناجح. أقرب تشابه في السجل بلغ 0.12 وهو أقل من حد التعارض 0.75.",
