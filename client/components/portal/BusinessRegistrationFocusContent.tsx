  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "• وكيل الكلمات المحظورة → ناجح. لم يتم العثور على مفردات محظورة في النسخ ا��إنجليزية أو العربية.",
        ...
        "• محرك القرار النهائي → قيد الانتظار للمراجعة اليدوية. يُنصح بالتصعيد أو اختي��ر نشاط متوافق.",
...
const AGENT_OUTCOME_KEYWORDS: Record<AgentOutcome, string[]> = {
  ...
  rejected: ["reject", "rejected", "مر��وض"],
  info: [
    "guidance",
