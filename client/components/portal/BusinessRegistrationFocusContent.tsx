...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "2. وكيل الكلمات المحظورة → ناجح. لم يتم رصد مفردات محظورة في النس��تين العربية أو الإنجليزية.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "4. وكيل التح��يل الصوتي → ناجح. النسخة العربية متوافقة مع القواعد الصوتية.",
    "5. وكيل توافق النشاط → إرشاد. النهج التراثي يتطلب تحققًا يدويًا من خطة ا��نشاط.",
