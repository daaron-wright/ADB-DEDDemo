  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '1. مدقق النص / التدقيق الإملائي / الفحص الثقافي → ناجح. اجتاز الاسم "بيت الخيريار" التحقق النصي دون مخالفات (زمن المعالجة 653 مللي ثانية).',
        "2. وكيل الكلمات المحظورة → ناجح. لم يتم رصد مفردات محظورة في النسختين العربية أو الإنجليزية.",
        "3. وكيل التشابه → ناجح. لم يتم العثور على أسماء تجارية متعارضة؛ سجل المطابق أظهر صفراً من النتائج المتقاربة.",
        "4. وكيل التحويل الصوتي → ناجح. أكد محرك Buckwalter التوافق ال��وتي للنسخة العربية بدرجة ثقة 0.95.",
        "5. وكيل توافق النشاط → ناجح. الاسم ما يزال متوافقاً مع نشاط المطاعم والمشروبات المرخّص.",
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "• وكيل الكلمات المحظورة → ناجح. لم يتم العثور على مفردات محظورة في النسخ اإنجليزية أو العربية.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل التحويل الصوتي → ناجح. تمت المصادقة على التحويل «مط��م مروة» وفق القواعد الصوتية.",
