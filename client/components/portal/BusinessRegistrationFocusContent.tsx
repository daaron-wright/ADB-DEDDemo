  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '1. مدقق النص / التدقيق الإملائي / الفحص الثقافي → ناج��. اجتاز الاسم "بيت الختيار" التحقق النصي دون مخالفات (زمن المعالجة 653 مللي ثانية).',
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "2. وكي�� الكلمات المحظورة → ناجح. لم يتم رصد مفردات محظورة في النسختين العربية أو الإنجليزية.",
