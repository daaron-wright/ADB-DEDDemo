...
const TRADE_NAME_CHECKS: ReadonlyArray<TradeNameVerificationStep> = [
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '• م��قق ا��نص / الت��قيق الإملائي / الفحص الثقافي → ناجح. تم توحيد "ب��ت الختيار" دون تعا��ضات ث��افية.',
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        "استجابات الوكلاء (العربية):",
        '• مدقق النص / التدقيق الإملائي / الفحص الثقافي → ناجح. تم توح��د "Marwa Restaurant" والتأكد من الملاءمة ��لثقافية.',
