  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "4. وكيل التحويل الصوت�� → ناجح. أكد محرك Buckwalter التوافق الصوتي للنسخة العربية بدرجة ثقة 0.95.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• و��يل التحويل الصوتي → ناجح. تمت المصادقة على التحويل «مطعم مروة» وفق القواعد الصوتية.",
