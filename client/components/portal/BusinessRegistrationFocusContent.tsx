  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '1. مدقق النص / التدقيق الإمل��ئي / الفحص الثقافي → ناجح. اجتاز الاسم "بيت الختيار" التحق�� النصي دون مخالفات (زمن ��لمعالجة 653 ��للي ثانية).',
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    hasIteration
      ...
      : "7. وكيل اقتراح الاسم (الاس�� المرف��ض) → إرشاد. ��وصي Polaris بإضافة توصيف خاص أو جغرافي.",
  ];
