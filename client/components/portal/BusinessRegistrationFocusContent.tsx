  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "2. وكيل الكلمات ��لمحظورة → ناجح. لم يتم رصد مفردات محظور�� في النسختين العربية أو ��لإنجليزية.",
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '• مدقق ا��نص / الت��قيق الإملائي / الف��ص الثقافي → ناج��. تم توحيد "ب��ت الختيار" دون تعا��ضات ث��افية.',
