  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "6. محرك القرار النهائي → مرفو��. إشعار RTN-08 المعياري: تم تسجيل هذا الاسم التجاري مسبقًا، يُرجى اقتراح بديل.",
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "• وكيل توافق ال��شاط → إرشاد. ��لاسم يشير ��لى مفهوم تراثي للبيع بالتجزئة وليس نشاط مطعم ومشروبات الحالي.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "6. محرك القرار النهائي → تم التصعيد للمراجعة. لست واثقًا من الرفض الآلي لذلك تم رفعه لمراجع دائرة التنمية الاق��صادية للتوجيه.",
        ...
        if (next >= 100) {
          ...
          if (isSuccess) {
            ...
            if (iterationSuggestion) {
              applyIterationDraft(iterationSuggestion);
            }
            setTradeNameGuidance(
              iterationSuggestion
