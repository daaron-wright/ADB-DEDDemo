  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '4. وكيل التحويل الصوتي → ناجح. تم التحقق من التحوي�� "بيت الختي��ر" وفق القواعد الصوتية.',
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل توافق النشاط → ناجح. الاسم يتوافق مع نشاط المطع�� المر��ّص.",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "2. وكيل الكلمات المحظورة → ناجح. لم يتم رصد مفردات محظورة في النسختين العربية أو الإنجليزية.",
    `3. وكيل التشابه → فشل. تمت مطابقة الا��م المسجل "${PRIMARY_TRADE_NAME_AR}" بدرجة تشابه ${SIMILARITY_CONFLICT_SCORE.toFixed(2)} (${SIMILARITY_CONFLICT_REFERENCE}).`,
    "4. وكيل التحويل الصوتي → متوقف مؤقتًا. يجب حل التعارض قبل تأكيد النسخة العربية.",
