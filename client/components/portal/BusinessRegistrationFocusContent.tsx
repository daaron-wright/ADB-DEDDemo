  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "5. وكيل توافق النشا�� → ناجح. الاسم ما ��زال متوافقاً مع نشاط المطاعم والمشرو��ا�� المرخّص.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "6. محرك القرار النهائي → تم التصعيد للمراجعة. لست واثقًا من الرفض ال��لي لذلك تم رفعه لمراجع دائرة التنمية الاقتصادية للتوجيه.",
