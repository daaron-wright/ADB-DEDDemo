  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '7. وكيل اقتراح الاسم (الاسم ا��مرفوض) → إرشاد. من البدائل الموصى بها: "ساحة ��لخي��يار".',
      ].join("\n"),
    },
  },
  {
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "��� وكيل اقتراح الا��م (الاسم المرفوض) → ل�� حاجة لبدائل�� الاسم الحالي معتمد.",
      ].join("\n"),
    },
  },
  {
