  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '4. وكيل التحويل الصوتي → ناجح. تم التحقق من التحويل "بيت الختيار" وفق القواعد الصو��ية.',
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل الكلمات المحظورة → ��اجح. لم يتم العثور على مصطلحات محظورة في النسختين العربية والإنجليزية.",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    `6. محرك القرار النهائي → مفوض. مرجع الت��ارض ${SIMILARITY_CONFLICT_REFERENCE}؛ يُرجى اقتراح اسم مختلف.`,
    hasIteration
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "7. وكيل اقتراح الاسم → إرشاد. جهّز المبررات الداعمة قبل ��لتصعيد.",
  ];
