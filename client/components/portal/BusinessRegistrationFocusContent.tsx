  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '1. مدقق النص / التدقيق الإملائي / الفحص الثقافي → ناجح. اجتاز الاسم "بيت الختيار" التحق�� النصي ��ون مخالفات (زمن ��لمعالجة 653 ��للي ثانية).',
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    `1. مدقق النص / الت��قيق الإم��ائي / ��لفحص الثقافي → ناجح. اجتاز الا��م "${formattedAttempt}" الت��قق الن��ي دون ��خالفات.`,
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    `1. مدقق النص / التدقيق ا��إملائي / الفحص الثقافي → ناجح. تم اعتماد "${formattedAttempt}" دون مخالفات.`,
