  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "4. وكيل التحويل ا��صوتي → ناجح. أكد محرك Buckwalter التوافق الصوتي للنسخة العربية بدرجة ثقة 0.95.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل التشابه → ناجح. أقرب تشابه في السجل بلغ 0.12 وهو أقل من حد ال��عا��ض 0.75.",
