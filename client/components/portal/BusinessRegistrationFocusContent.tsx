  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "3. وكيل التشابه → ناجح. لم يتم العثور على أسماء تجارية متعارضة؛ سج�� المطابقة أظهر صفراً من النتائج ا��متقار��ة.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل التشابه → ناجح. أقرب تشابه في السج�� بلغ 0.12 وهو أقل من حد ال��عارض 0.75.",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    `3. وكيل التشابه → فشل. تمت مطابقة الاسم المسجل "${PRIMARY_TRADE_NAME_AR}" بدرجة تش��به ${SIMILARITY_CONFLICT_SCORE.toFixed(2)} (${SIMILARITY_CONFLICT_REFERENCE}).`,
