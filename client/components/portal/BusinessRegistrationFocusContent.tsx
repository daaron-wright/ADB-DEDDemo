...
const TRADE_NAME_CHECKS: ReadonlyArray<TradeNameVerificationStep> = [
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        '1. ����قق النص / التدقيق الإملائي / الفحص ا��ثقافي → ناجح. اتاز الاسم "بيت الختيار" التحقق النصي دون مخالفات.',
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "2. وكيل الكلمات المحظورة �� ناجح. لا توجد مفردات محظورة ��ي النسختين الإنجليزية أو العر��ية.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        '• مدقق النص / التدقيق الإملائي / ��لفحص الثقافي → ناجح. تم ��و��يد "Marwa Restaurant" والتأكد من الملاءمة الثقافية.',
