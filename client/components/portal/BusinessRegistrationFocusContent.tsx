  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "5. وكيل توافق الن��اط �� إرشاد. ننتظر اسمًا تجاريًا ��ريدًا لموازنته مع النشاط المرخَّص.",
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        ...
        "• وكيل الكل��ات المحظو��ة → ناجح. لم يتم العثور على مصطلحات م��ظورة في النسختين العربية والإنجلي��ية.",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "4. وكيل التحويل الصوتي → متوقف مؤقتًا. يجب حل التعارض قبل تأكيد النسخة العربية.",
    "5. وكي�� توافق النشاط → إرشاد. ننتظر اسمًا ��جاريًا فريدًا قبل التقييم.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "2. وكيل الكلمات المحظورة → ناجح. لا توجد مفردات محظو��ة في المسودة.",
    ...
    "6. محرك القرار النهائي → تم التصعيد للمراجعة. لسنا واثقين من الرفض الآلي، لذلك تم رفعه لمراجع ��ائرة التنم��ة الاقتصادية لتحديد الإجراء.",
