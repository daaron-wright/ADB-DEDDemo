...
const TRADE_NAME_CHECKS: ReadonlyArray<TradeNameVerificationStep> = [
  ...
  },
  {
    ...
    successDetail: {
      ...
      ar: [
        "استجابات الوكلاء (العربية):",
        '• مدقق النص / التدقيق الإملائي / الفحص الثقافي → ناجح. تم توحي�� "Marwa Restaurant" والتأكد من الملاءمة ����لثقافية.',
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "6. محرك القرار النهائي → تم التصعيد للمراجعة. لست واثقًا من الرفض الآل�� لذلك تم رفعه لمراجع دائرة التنمية الاقت��ادي�� للتوجيه.",
