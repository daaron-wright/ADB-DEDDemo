  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '3. وكيل التشابه → فشل. تمت مطابق�� الاسم المسجل "بيت الختيار" بد��جة تشابه 0.81 (SIMILARITY_CONFLICT).',
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "5. وكيل توافق النشاط → فشل. الاسم يوحي بمفهوم تراثي للبيع بالتجزئة وليس نشاط المطع�� الحالي.",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    `6. محرك القرار النهائي → مرفوض. مرجع التعارض ${SIMILARITY_CONFLICT_REFERENCE}؛ يُرجى اقتراح اسم مخت��ف.`,
    hasIteration
