  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        '3. وكيل التشابه → فشل. ��مت مطابقة الاسم المسجل "بيت الختيار" بدرجة ت��ابه 0.81 (SIMILARITY_CONFLICT).',
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "3. وكيل التشابه → ناجح. أق��ب تشابه مسجل بنسبة 0.28 (أقل من الحد المطلوب).",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    "4. وكيل التحويل الصوتي → متوقف مؤقتًا. يجب حل التعارض قبل ��أكيد النسخة العربية.",
                  ...
                  step.title === "Full decision flow"
                    ...
                    : {
                        ...
                        hideStructuredResponses:
                          step.title === "Similarity agent" && !showActivitySelectorsInline,
                      },
                )}
              </div>
            ) : (
