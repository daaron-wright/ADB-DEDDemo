  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "3. وكيل التشابه → ناجح. لم يتم العثور على أسماء تجارية متعارضة؛ سجل المطابقة أظهر صفراً من النتائج المتقاربة.",
        "4. وكيل التحويل الصوتي → ن��جح. أكد محرك Buckwalter التوافق الصوتي للنسخة العربية بدرجة ثقة ‎0.95‎.",
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "• وكيل التشابه → ناجح. أقرب تشاب�� مسجل بنسبة 0.28 (أق�� من الحد المطلوب).",
