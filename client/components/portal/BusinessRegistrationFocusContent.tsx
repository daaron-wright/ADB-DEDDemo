...
const TRADE_NAME_CHECKS: ReadonlyArray<TradeNameVerificationStep> = [
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        '1. مدقق النص / التدقيق الإملائي / الفحص الثقافي → ناجح. اجتاز الاسم "بيت الختيار" التحقق ��لنصي دون مخالفات.',
  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        '1. مدقق النص / التدقيق الإملائي / الفحص ال��قافي → ناجح. تم توحيد "بيت الختيار" دون تعارضات ثقافية.',
