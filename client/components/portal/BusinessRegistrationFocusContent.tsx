  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "2. وكيل الكلمات ��لمحظورة → ناجح. لم يتم رصد مفردات م��ظورة في النسختين العربية أو الإنجليزية.",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    `1. مدقق النص / التدقيق الإم��ائي / ��لفحص الثقافي → ناجح. اجتاز الا��م "${formattedAttempt}" الت��قق الن��ي دون ����الفات.`,
        ...
        if (next >= 100) {
          ...
          if (isSuccess) {
            ...
            if (iterationSuggestion) {
              ...
              if (!hasAppliedFirstSimilarityIteration) {
                setHasAppliedFirstSimilarityIteration(true);
              }
            }
            setTradeNameGuidance(
              iterationSuggestion
