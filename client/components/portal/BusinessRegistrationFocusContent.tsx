  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "6. محرك القرار النهائي → مرفو��. إشعار RTN-08 المعياري: تم تسجيل هذا الاسم التجاري مسبقًا، يُ��جى اقتراح بديل.",
...
function buildSimilarityConflictNarrative(
  ...
  const arabicLines = [
    ...
    `6. محرك القرار النهائي → مرفوض. مرج�� التعارض ${SIMILARITY_CONFLICT_REFERENCE}؛ يُرجى اقتر��ح اسم مختل��.`,
    hasIteration
