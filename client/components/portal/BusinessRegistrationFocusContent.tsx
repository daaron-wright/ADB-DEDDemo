  ...
  },
  {
    ...
    failureDetail: {
      ...
      ar: [
        ...
        "�� محرك القرار النهائي → قيد الانتظار للمراج��ة اليدوية. يُ��صح بالتصعيد أو اخ��يار نشاط متواف��.",
...
function buildFinalDecisionRejectionNarrative(
  ...
  const arabicLines = [
    ...
    "5. و��يل توافق النشاط → إرشاد. النهج التراثي يتطلب تحققًا يدويًا من خطة النشاط.",
