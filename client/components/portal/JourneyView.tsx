...
import {
  ...
  type ActorOption,
} from "./BusinessActivitiesSelection";
...
export function JourneyView({
  ...
  const [aiStatus] = useState<"listening" | "speaking" | "thinking" | "idle">(
    "speaking",
  );
