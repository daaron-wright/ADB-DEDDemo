      ...
      <div className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3">
        <div className="w-[320px] rounded-3xl border border-white/50 bg-white/80 px-5 py-5 shadow-[0_22px_52px_-28px_rgba(11,64,55,0.38)] backdrop-blur-2xl">
          <div className="flex items-start gap-3">
            <span className="inline-flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-[#0f766e] text-white shadow-[0_14px_30px_-20px_rgba(11,64,55,0.5)]">
