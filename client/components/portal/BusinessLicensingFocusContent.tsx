...
> = {
  request: {
    ...
    description:
      "Polaris is compiling your commercial details and preparing the request package for the Department of Economic Development.",
  },
  in_progress: {
    headline: "Automating application process",
    automationTitle: "Syncing with DED",
    description:
      "Polaris is automating the license application process with regulatory authorities.",
  },
  pending: {
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="space-y-1">
                ...
                <p className="text-sm text-slate-600">
                  Polaris is coordinating with the Department of Economic Development.
                </p>
              </div>
              <Badge
                className={cn(
