  ...
  return (
    <>
      ...
      >
        ...
        <section className="mt-6 rounded-3xl border border-[#d8e4df] bg-white shadow-[0_16px_36px_-28px_rgba(11,64,55,0.22)]">
          <Accordion type="single" collapsible defaultValue="application-details">
            <AccordionItem value="application-details" className="border-0">
                ...
                <div className="flex items-center justify-between w-full">
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">
                      {applications[0].directorate} • {applications[0].status}
                    </p>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-right">
                      <div className="text-sm font-medium text-slate-900">{applications[0].progress}%</div>
              ...
              <AccordionContent className="px-8 pb-6">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900 mb-2">Summary & Next Action</h4>
                    <p className="text-sm text-slate-600 mb-3">{applications[0].summary}</p>
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                      <h5 className="font-medium text-blue-900 text-sm mb-1">Next Action Required</h5>
                      <p className="text-sm text-blue-800">{applications[0].nextAction}</p>
                    </div>
                  </div>
                </div>
                <div className="mt-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-slate-600">{applications[0].progress}%</span>
                  </div>
                  <Progress value={applications[0].progress} className="h-2" />
                </div>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
