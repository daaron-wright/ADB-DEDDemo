          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:gap-10">
            ...
            <div className="flex-1 rounded-3xl border border-[#d8e4df] bg-[#f9fbfa] p-6">
              ...
              {currentAnimationPhase ? (
                <div className="mt-6 rounded-2xl border border-[#cce7de] bg-white p-5 shadow-[0_14px_28px_-24px_rgba(11,64,55,0.24)] transition-all">
                  ...
                  <div className="mt-4 space-y-3">
                    <div>
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {currentAnimationPhase.keyConsiderations.map((item) => (
                          <span
                            key={item}
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {currentAnimationPhase.dataTags.map((item) => (
                          <span
                            key={item}
