              ...
              >
                <div className="flex items-center justify-between text-slate-900">
                  <div className="flex items-center gap-4">
                    <div className="bg-[#0f766e]/10 rounded-full p-2">
                      <svg className="w-5 h-5 text-[#0f766e]" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                      </svg>
                    </div>
                    <div className="text-left">
                      <h3 className="font-semibold text-lg text-slate-900">{applications[0].title}</h3>
                      <p className="text-slate-600 text-sm">{applications[0].directorate}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="bg-[#dff2ec] border border-[#94d2c2] rounded-full px-4 py-2">
                      <span className="text-sm font-medium text-[#0b7d6f]">{applications[0].status}</span>
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-bold text-slate-900">{applications[0].progress}%</div>
