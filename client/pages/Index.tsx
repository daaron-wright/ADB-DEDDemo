    ...
    () => [
      {
        ...
        prompt:
          "What are the strongest market signals for launching a restaurant in Abu Dhabi right now?",
        description:
          "Get a quick snapshot of demand, customer trends, and emerging concepts.",
      },
      {
        id: "licensing-steps",
        title: "Map my licensing steps",
        prompt:
          "Can you walk me through the key steps and documents needed to set up my restaurant license?",
        description:
          "See the end-to-end journey so you know what to prepare first.",
      },
      {
        id: "location-insights",
        title: "Compare neighbourhoods",
        prompt:
          "Which Abu Dhabi districts are the best fit for a premium dining concept and why?",
      ...
      },
      {
        ...
        prompt:
          "What budget range should I plan for to open a mid-sized restaurant, including fit-out and staffing?",
        description:
          "Understand the upfront investment and ongoing costs before you commit.",
      },
    ],
    [],
  );
    ...
    >
      <div
        className={cn(
          ...
          (chatState.isOpen || isPromptModalOpen) &&
