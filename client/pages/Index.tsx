...
const VOICE_CALL_OVERLAY_MESSAGE = "Al Yah Voice Narration";
const VOICE_CONNECTING_MESSAGE =
  "Al Yah is preparing a guided narration for you…";
const VOICE_NARRATION_AUDIO_URL =
  "https://cdn.builder.io/o/assets%2F4f55495a54b1427b9bd40ba1c8f3c8aa%2F6f8fe0b77fb74e94bd9c73b5677993b4?alt=media&token=cdeaebea-1299-42fa-b58d-c3d5f4aeae0a&apiKey=4f55495a54b1427b9bd40ba1c8f3c8aa";
  ...
  return (
    <div className="relative flex h-12 w-12 flex-shrink-0 items-center justify-center">
      <motion.span
        ...
        animate={{ scale: [1, 1.26, 1], opacity: [0.28, 0.58, 0.28] }}
        transition={{
          duration: 3.6,
          repeat: Infinity,
          repeatType: "mirror",
      ...
      <motion.span
        aria-hidden="true"
        className="absolute inset-0 rounded-full border border-[#0F766E]/35"
        animate={{ scale: [1.05, 1.32, 1.05], opacity: [0.48, 0.16, 0.48] }}
        transition={{
          duration: 4,
          repeat: Infinity,
          repeatType: "mirror",
      ...
      <motion.span
        ...
        style={{ boxShadow: "0 18px 40px -28px rgba(15,118,110,0.55)" }}
      ...
      <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-[#0F766E]/24 bg-white">
        {hasAvatar ? (
          <motion.img
            ...
            animate={{
              scale: [1, 1.052, 0.99, 1.038, 1],
              rotate: [-2.6, -0.4, 2.2, -1.4, 0.2],
              y: [0, -0.9, 0.5, -0.8, 0],
            }}
            transition={{
              duration: 3.6,
...
export default function Index() {
  ...
  const triggerVoiceCall = useCallback(async () => {
    ...
    if (voiceNarrationLoadingRef.current || voiceNarrationActiveRef.current) {
      return;
    }
                    ...
                    <div className="flex items-start gap-3">
                      <div className="relative flex h-11 w-11 flex-shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#0F766E]/15 bg-white shadow-[0_12px_30px_-18px_rgba(22,101,76,0.45)]">
                        {hasAlYahAvatar ? (
                          ...
                          <span className="h-6 w-6 rounded-full bg-[#0F766E]/20" />
                        )}
                      </div>
